...
<div class="container-fluid my-3">
        ...
        <div class="right col-sm-7">
            <div class="card border-0">
                <div class="card-body">
                    ...
                    <div class="price">
                            <h6 class="text-dark"><span class="text-secondary">Đơn giá: </span>&#8377; <?php echo $q['newPrice']; ?></h6>                           
                    </div>
                    <div class="quantity">
                            <h6 class="text-dark"><span class="text-secondary">Số lượng: </span><?php echo $quant; ?></h6>                           
                    </div>
                    <br>
                    <div class="total-price">
                            <h6 class="text-dark"><span class="text-secondary">Tổng tiền: </span>&#8377; <?php $total= $q['newPrice']*$quant; echo $total; ?></h6>                           
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card">
                                <div class="card-header ">Thông tin gửi hàng</div>
                                ...
                                <script>
                                    if(document.getElementById('shipadd').innerHTML.trim()==""){
                                        document.getElementById('shipadd').innerHTML="Mời kiếm tra lại thông tin bằng cách click nút bên dưới";
                                    }
                                </script>
                                <a class="btn btn-danger" target="_blank" href="myaccount.php#account-details">Cập nhật thông tin</a>
</div>
...
?>
    <a href="payu/PayUMoney_form.php" class="btn btn-primary">Tiếp tục</a>
</div>
