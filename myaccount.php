        ...
        <div class="col-sm-3">
            <nav class="navbar bg-white">
                <ul class="navbar-nav nav nav-pills" id="menu" role="tablist">
                    ...
                    <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#account-details">Thông tin chi tiết</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#cart">Giỏ hàng</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#favourite">Danh sách yêu thích</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#change-pass">Đổi mật khẩu</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#my-orders">Đơn hàng</a>
                    </li>
                </ul>
            </nav>
        </div>
        <div class="col-sm-9 tab-content">
                ...
                <div class="col-12">
                    ...
                    <div class="body px-5 py-2">
                        <div class="welcome-words">
                            <div class="hello h5">Chào <?php echo $userName;?> </div>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</p>
                        </div>
                        <div class="heading">
                        <h4 class="bg-white">Thông tin tài khoản</h4>
                        <hr>
                        </div>
                            <div class="card">
                                ...
                                <script>
                                    if(document.getElementById('shipadd').innerHTML.trim()==""){
                                        document.getElementById('shipadd').innerHTML="Cập nhật thông tin ở mục chi tiết tài khoản";
                                    }
                                </script>
                        </div>
                    </div>
            ...
            <section id="account-details" class="row tab-pane fade">
                        <div class="row">
                            <div class="col-12">
                                <div class="heading">
                                    <h2 class="bg-light p-3">Chi tiết tài khoản</h2>
                                </div>
                            </div>
                        </div>
                        ...
                        <form class="main-form full" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="heading-part">
                                    <h4 class="sub-heading">Thông tin thanh toán</h4>
                                </div>
                                <hr>
                                </div>
                                <?php
                                ...
                                <div class="col-md-6">
                                    <input name="shippingCountryId" value="Vietnam" id="shippingcountryid" disabled class="form-control">
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                <div class="input-box">
                                    <input type="text" required placeholder="Địa chỉ" name="city" value="<?php echo $q['city'];?>" class="form-control">
                                </div>
                                </div>
                                <div class="col-md-6">
                                <div class="input-box">
                                ...
                                <br>
                                    <button type="submit" name="subship" class="form-control btn btn-primary">Lưu</button>
            ...
            <section id="cart" class="row tab-pane fade">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="heading">
                            <h2 class="bg-light p-3">Giỏ hàng</h2>
                        </div>
                    </div>
                </div>
                ...
                <a href="buyNowCart.php" class="btn btn-primary">Thanh toán</a>
                </div>
            </section>
            <section id="favourite" class="row tab-pane fade">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="heading">
                            <h2 class="bg-light p-3">Yêu thích</h2>
                        </div>
                    </div>
                </div>
                <div class="row py-2" id="tab">
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th colspan="3"> 
                                            <ul class="pull-right">
                                                <li class="price-box"><span class="mx-2">Số lượng : </span> <span class="total text-danger"><?php echo count(json_decode($q['favourite']));?></span></li>
                                            </ul>
                                        </th>
                                    </tr>
                                </thead>
            ...
            <section id="my-orders" class="row tab-pane fade">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="heading">
                            <h2 class="bg-light p-3">Danh sách đơn hàng</h2>
                        </div>
                    </div>
                </div>
                <div class="row py-2" id="tab">
                    ...
                    <tr>
                        ...
                        <td><a target="_blank" href="viewOrder.php?id=<?php echo $qe['id'];?>" class="btn btn-primary btn-sm">Xem chi tiết</a></td>
                        <td> <button class=" btn btn-sm btn-danger" onclick='dispatched(<?php echo $qe['id'];?>)'> Trạng thái đơn hàng </button></td>
