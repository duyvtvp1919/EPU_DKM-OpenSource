                ...
                ?>
                    <div class="card">
                        ...
                        <div class="card-body pt-2">
                            ...
                            <a href="<?php echo 'single-product.php?id='.$q['id']; ?>" class="btn btn-primary px-5">Chi tiết</a>
                        </div>
                    </div>
                <?php } ?>
                </div>
                ...
                ?>
                    <div class="card">
                        ...
                        <div class="card-body pt-2">
                            ...
                            <a href="<?php echo 'single-product.php?category=camera&id='.$q['id']; ?>" class="btn btn-primary px-5">Chi tiết</a>
                        </div>
                    </div>
                <?php } ?>
                </div>
