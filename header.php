        ...
        <nav class="navbar navbar-dark navbar-expand-md bg-primary justify-content-between">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav collapsenav">
                    ...
                    <?php if(@$login){?>
                            <a href="logout.php" class="nav-link"><span class="fa fa-lock"></span> Đăng xuất
                        <?php }else{ ?>
                            <a href="login.php" class="nav-link"><span class="fa fa-lock"></span> Đăng nhập
                        <?php } ?></a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="col-sm-10 searchbar">    
                    ...
                    <select name="category" class="form-control bg-secondary text-white" id="category">
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-secondary" name="sub" type="submit" onclick="window.location.href='shop.php'">Tìm kiếm</button> 
                        </div>
                    </div>
