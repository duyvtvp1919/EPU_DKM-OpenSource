...
<footer>
        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-sm-6">
                    ...
                    <span>Đăng kí nhận thông tin qua email</span>
                </div>
                <div class="col-sm-6">
                    <form method="POST">  
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <button class="btn btn-secondary" type="submit" name="newsletterSubmit">Nhận thông tin</button> 
                                    </div>
                                </div>   
                    </form>
                </div>
    ...
    <div class="bg-dark text-white-50">
        <p class="mx-auto my-0 text-center p-4">&copy; Website designed and developed by <span class="text-white"> EPU DKM</span>.</p>
    </div>
</footer>
</body>
</html>