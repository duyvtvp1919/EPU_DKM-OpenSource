            ...
            <div class="card-body">
              <form class="main-form full" method="post">
                <div class="row">
                 ...
                 <div class="col-7">
                    <button name="submit" type="submit" class="btn btn-primary pull-right">Đăng nhập</button>
                  </div>
                  <div class="col-12"> <a title="Forgot Password" class="forgot-password mtb-20" href="forgotpass.php">Quên mật khẩu</a>
                    <hr>
                  </div>
                  <div class="col-12">
                    <div class="new-account text-center mt-20"> <span>Chưa có tài khoản?</span> <a class="link" title="Register with Everypick" href="register.php">Đăng kí ngay</a> </div>
                  </div>
                </div>
              </form>
            </div>
